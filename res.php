        ...
        ?>
         <style>
             body {
                 ...
                 background-image:url('https://i.pinimg.com/736x/0e/c3/10/0ec31000aba7eabf0011e4cf35844b1c.jpg');
                 min-height: 90vh;
    ...
    <div class="row">
             <div class="col">
                ...
                <tr>
                    <td>Student Id:</td>
                    <td>
                        <input type="number" value="<?php echo $row['stid'];?>" disabled>
                    </td>
                </tr>
                <tr>
                    <td>Student name:</td>
