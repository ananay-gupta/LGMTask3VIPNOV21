...
$sql = "INSERT INTO addition (stid,stname,gender,dob,class,sci,soc,math,eng,hindi,marks,grade)
values ('$stid','$stname','$gender','$dob','$class','$sci','$soc','$math','$eng','$hindi','$marks','$grade')";
if ($conn->query($sql)){
